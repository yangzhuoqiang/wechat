...
import 'package:wechat/widgets/camera/widget/take_photo.dart';
import 'package:wechat/widgets/camera/widget/take_video.dart';
            ...
            if (postType == 'image') {
              ...
              final AssetEntity? result = await CameraPicker.pickFromCamera(
                ...
                pickerConfig: const CameraPickerConfig(
                  ...
                  maximumRecordingDuration: Duration(seconds: maxVideoDuration),
                ),
              );
            }
          },
