...
import 'package:wechat/entity/timeline_likesAndcomments/result.dart';
...
class _GalleryWidgetState extends State<GalleryWidget>
  ...
  //SingleTickerProviderStateMixin避免动画播放异常
//  是否显示appbar
  bool visible = true;
  // video控制器
...
//  初始加载视频
    ...
    return ExtendedImageGesturePageView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return ExtendedImage(
          ...
          fit: BoxFit.contain,
          mode: ExtendedImageMode.gesture, //设置模式为可缩放拖拽
  ...
  Widget _mainView() {
    ...
    return GestureDetector(
      behavior: HitTestBehavior.opaque, //不允许点击透明部分穿透事件
